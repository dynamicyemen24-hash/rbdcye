    ...
    return [
      {
        ...
        excerpt:
          "أطلقت حملة رحماء بينهم مشروعها السنوي للتعليم المستدام الذي يستهدف أكثر من ٥٠٠ طالب وطالبة في المناطق النائية.",
        content: "",
        category: "تعليم",
      ...
      },
      {
        ...
        excerpt:
          "وقّعت الحملة اتفاقية شراكة استراتيجية مع منظمة التنمية الخليجية لمدة ثلاث سنوات.",
        content: "",
        category: "شراكات",
  ...
  private getStaticStories(): any[] {
    return [
      ...
      },
      {
        ...
        story: "وزّعت الحملة آلاف السلال الغذائية خلال رمضان.",
        excerpt: "وزّعت الحملة آلاف السلال الغذائية خلال رمضان.",
