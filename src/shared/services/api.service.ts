...
export const donationsApi = {
  create: (data: Record<string, unknown>) =>
    apiRequest("donations", { method: "POST", body: data }),
};
...
export const volunteersApi = {
  register: (data: Record<string, unknown>) =>
    apiRequest("volunteers", { method: "POST", body: data }),
};

export const subscribersApi = {
  subscribe: (data: Record<string, unknown>) =>
    apiRequest("subscribers", { method: "POST", body: data }),
};
...
export const erpApi = {
  ...
  createDonation: (data: Record<string, unknown>) =>
    apiRequest("erp?action=create-donation", { method: "POST", body: data }),
  registerVolunteer: (data: Record<string, unknown>) =>
    apiRequest("erp?action=register-volunteer", { method: "POST", body: data }),
  partnershipRequest: (data: Record<string, unknown>) =>
    apiRequest("erp?action=partnership", { method: "POST", body: data }),
};
...
export const adminAuth = {
  ...
  getUser: (): { id: string; email: string; name: string; role: string } | null => {
    try {
      return JSON.parse(localStorage.getItem("rbdcye_admin_user") || "null") as {
        id: string;
        email: string;
        name: string;
        role: string;
...
export const adminProjects = {
  ...
  create: (data: Record<string, unknown>) =>
    apiRequest("admin?action=projects", { method: "POST", body: data }),
...
export const adminNotifications = {
  ...
  markRead: (ids?: string[]) =>
    apiRequest("admin?action=notifications", { method: "PUT", body: { ids } }),
};
