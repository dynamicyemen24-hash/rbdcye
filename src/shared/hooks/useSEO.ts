...
export const DEFAULT_SITE_TITLE =
  "مؤسسة رحماء بينهم | الموقع الإلكتروني التعريفي الرسمي للإغاثة والتنمية باليمن";
export const DEFAULT_SITE_DESCRIPTION =
  "الموقع الإلكتروني التعريفي الرسمي لمؤسسة رحماء بينهم للإغاثة والتنمية باليمن - استعراض الرؤية، الأهداف، الأثر التنموي، وأرفع معايير الحوكمة والشفافية.";
...
export const ROUTE_SEO_MAP: Record<string, RouteSEOConfig> = {
  ...
  "/about": {
    ...
    description:
      "تعرف على رؤية ورسالة ومسيرة مؤسسة رحماء بينهم الخيرية وإنجازاتها الميدانية في خدمة المجتمع وتمكين الأسر المستضعفة.",
  ...
  "/news": {
    ...
    description:
      "تابع آخر الأخبار، التغطيات الميدانية، والتقارير الصحفية حول أنشطة وفعاليات ومشاريع مؤسسة رحماء بينهم.",
  ...
  "/partners": {
    ...
    description:
      "استعرض قائمة المنظمات والجهات الشريكة الداعمة لمسيرة مؤسسة رحماء بينهم في تحقيق التنمية والإغاثة.",
