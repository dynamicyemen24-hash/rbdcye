  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={togglePlay}
          className="p-2 rounded-full hover:bg-white/15 transition-all text-white/80 hover:text-white"
      ...
      .then((result) => {
        ...
        setMetrics(
          data
            ? {
                totalBeneficiaries:
                  data?.totalBeneficiaries || data?.beneficiaries || fallback.totalBeneficiaries,
