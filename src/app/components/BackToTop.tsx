    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          className="fixed bottom-[var(--dock-bottom)] right-[var(--dock-right)] z-50 h-12 w-12 rounded-full bg-[var(--card)] border border-[var(--border)] shadow-lg flex items-center justify-center group"
