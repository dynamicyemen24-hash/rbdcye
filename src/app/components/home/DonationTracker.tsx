    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-3xl p-6 border border-[var(--border)]">
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 right-6 w-0.5 bg-[var(--brand-green)] transition-all duration-500" style={{ height: '33%' }} />
                ...
                <div className="flex-1 pb-6">
                  <div className="flex items-center gap-2 mb-1">
                    <h4 className={`font-bold text-sm ${
                      step.status === 'completed' ? 'text-[var(--brand-green)]' :
                      step.status === 'current' ? 'text-[var(--brand-gold)]' :
                      'text-gray-400'
                    }`}>
                      {step.title}
                    </h4>
      ...
      <div className="bg-white rounded-3xl p-6 border border-[var(--border)]">
        ...
        <div className="grid grid-cols-2 gap-3">
          {IMPACT_CATEGORIES.map((cat, i) => (
            ...
            >
              <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-2" style={{ backgroundColor: `${cat.color}15` }}>
