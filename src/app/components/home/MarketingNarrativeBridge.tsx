  ...
  const narrativeStories = [
    {
      ...
      description:
        "أم محمد فقدت كل شيء في الصراع. وجدناها تبكي أمام بابها المكسور. اليوم أطفالها يأكلون ويدرسون. لم نُطعمهم فقط — أعدنا لهم الأمل.",
    ...
    },
    {
      ...
      impact: "قرية كاملة",
      description:
        "قرية في الريف الحديدي لم يكن فيها ماء نظيف. بناء بئر ارتوازي واحد حوّل حياة أسر كاملة — من العزلة إلى صحة وتعليم.",
      cta: "اكتشف المشروع",
    },
    {
      id: "3",
      ...
      description:
        "خالد كان طالب جامعي. سجّل في برنامج التطوع لأنهم كانوا بحاجة ليد. اليوم يقود فريقاً في المحافظة. لم يكن يعلم أنه يبني وطنه.",
      cta: "شارك معنا",
    },
  ];
      ...
      <div className="section-container">
        <div className="max-w-6xl mx-auto">
                ...
                <div className="relative z-10 p-6 md:p-8">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[var(--muted-foreground)]">{story.subtitle}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-sm text-[var(--muted-foreground)]">الأثر المحقق</span>
                  </div>
          ...
          <div className="mt-16 pt-8 border-t border-[var(--border)]/60 text-center">
            <p className="text-[var(--muted-foreground)] mb-4">كل قصة تلهم، وكل تبرع يصنع فرقاً</p>
