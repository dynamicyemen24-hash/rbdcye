    ...
    <div className="relative">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full">
          ...
          {/* Impact text */}
          <h3 className="text-2xl md:text-3xl font-bold mb-4 leading-relaxed">{impact}</h3>

          {/* Donor name */}
          <p className="text-[var(--brand-gold-light)] text-lg mb-2">{donorName}</p>
          ...
          {/* Project */}
          <p className="text-white/60 text-sm mb-8">{project}</p>
