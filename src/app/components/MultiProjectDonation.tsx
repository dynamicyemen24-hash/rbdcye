...
const PAYMENT_METHODS = [
  ...
  {
    id: "moyasar" as PaymentMethod,
    name: "Moyasar",
    icon: CreditCard,
    desc: "مدى - فيزا - ماستركارد",
  },
...
export default function MultiProjectDonation() {
  ...
  // UI state
  const [step, setStep] = useState<"projects" | "amount" | "info" | "confirm" | "receipt">(
    "projects"
  );
        ...
        <div className="flex items-center gap-2 mt-4">
          {[
            ...
            <div key={s.id} className="flex items-center gap-1">
              ...
              <span
                className={`text-xs ${step === s.id ? "text-white font-semibold" : "text-white/60"}`}
              >
                {s.label}
              </span>
      ...
      <div className="p-6 space-y-6">
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ background: isSelected ? "#05966920" : "#F3F4F6" }}
                    >
                      <Icon
                        className="w-5 h-5"
                        style={{ color: isSelected ? "#059669" : "#6B7280" }}
                      />
                    </div>
                    <h4 className="font-semibold text-gray-800 text-sm mb-1">
                      {project.projectName}
                    </h4>
                    {project.projectImage && <p className="text-xs text-gray-500">اضغط للاختيار</p>}
                  </motion.button>
                );
              })}
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
                ...
                <div className="bg-gradient-to-l from-emerald-50 to-white rounded-2xl p-5 border border-emerald-100 space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-semibold text-gray-700">
                      توزيع {totalAmount.toLocaleString("ar-SA")} ريال
                    </span>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3 border border-gray-200 rounded-xl text-sm font-semibold hover:bg-gray-50 transition-all"
              >
                رجوع
              </button>
              <motion.button
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                >
                  الاسم الكامل {!isAnonymous && <span className="text-red-500">*</span>}
                </label>
                <input
                  id="donor-name"
                  type="text"
            ...
            <div className="bg-gradient-to-l from-emerald-50 to-white rounded-2xl p-5 border border-emerald-100">
              ...
              <div className="space-y-2 mb-4">
                  ...
                  .map((a) => (
                    <div key={a.projectId} className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-semibold text-gray-800">
                        {a.amount.toLocaleString("ar-SA")} ريال
                      </span>
                    </div>
                  ))}
                <div className="border-t border-emerald-200 pt-2 flex items-center justify-between">
                  ...
                  <span className="font-bold text-lg text-[var(--brand-green)]">
              ...
              <div className="grid grid-cols-1 gap-2">
                {PAYMENT_METHODS.map((method) => (
                  ...
                  >
                    ...
                    >
                      <method.icon
                        className={`w-5 h-5 ${paymentMethod === method.id ? "text-white" : "text-gray-500"}`}
                      />
                    </div>
            ...
            <div className="space-y-3">
              <label htmlFor="agree-terms" className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-sm text-gray-600">
                  أقر بأن هذا تبرع خيري طوعي، وأوافق على استخدام المبلغ بحسب تقدير رحماء بينهم
                  لتحقيق أهدافها الإنسانية
            ...
            <div className="bg-white rounded-2xl p-6 border-2 border-emerald-100 shadow-lg text-right">
              <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-100">
                ...
                <div className="text-left">
                  ...
                  <p className="font-mono text-sm font-bold text-[var(--brand-green)]">
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="border-t border-emerald-100 pt-3 flex items-center justify-between">
                  ...
                  <span className="text-lg font-bold text-[var(--brand-green)]">
                    {receipt.totalAmount.toLocaleString("ar-SA")} ريال
                  </span>
                </div>
              </div>
                    ...
                    {receipt.allocations
                      ...
                      .map((a) => {
                        ...
                        return (
                          <p key={a.projectId}>
                            • {a.projectName}:{" "}
                            <span className="font-semibold text-emerald-700">{beneficiaries}</span>{" "}
                            مستفيد
                          </p>
                        );
                      })}
            ...
            <div className="flex gap-3">
              <motion.button
                onClick={() => {
                  ...
                  if (navigator.share) {
                    navigator
                      .share({ title: "تبرعي لرحماء بينهم", text, url: window.location.href })
                      .catch(() => {});
                  } else {
        ...
        {!["projects", "amount", "info", "confirm", "receipt"].includes(step) && (
          <div className="text-center py-8">
            ...
            <button
              onClick={handleNewDonation}
              className="mt-4 px-6 py-2 bg-[var(--brand-green)] text-white rounded-xl font-semibold"
            >
              بدء تبرع جديد
            </button>
          </div>
