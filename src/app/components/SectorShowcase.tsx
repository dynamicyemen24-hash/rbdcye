...
export const SectorShowcase: React.FC<SectorShowcaseProps> = memo(
  ({ setCurrentPage = () => {} }) => {
    const [activeSectorId, setActiveSectorId] = useState<string>(SECTORS_SHOWCASE_DATA[0].id);

    const activeSector =
      SECTORS_SHOWCASE_DATA.find((s) => s.id === activeSectorId) || SECTORS_SHOWCASE_DATA[0];
    const ActiveIcon = ICON_MAP[activeSector.iconName] || Target;

    return (
      <section
        className="section-padding-lg bg-slate-50 relative overflow-hidden font-cairo"
        dir="rtl"
        id="sectors-showcase"
      >
        ...
        <div className="container-standard relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[var(--brand-green)]/10 text-[var(--brand-green)] text-xs font-bold font-cairo border border-[var(--brand-green)]/20 mb-3.5 shadow-2xs"
            >
              <Target className="w-3.5 h-3.5 text-[var(--brand-gold)]" />
            ...
            >
              عرض الشفافية والربط{" "}
              <span className="text-[var(--brand-green)]">بين القطاعات والأثر</span>
            </motion.h2>
            ...
            >
              عرض موحد وشامل يربط كل قطاع تنموي بمشاريعه الميدانية التنفيذية وقصص النجاح الموثقة
              لتقليل التكرار وتجسيد الشفافية.
            </motion.p>
          </div>
          ...
          <div
            ...
            role="tablist"
            aria-label="عرض القطاعات التنموية"
          >
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-2.5 px-4 sm:px-6 py-3 rounded-2xl text-xs sm:text-sm font-black font-cairo transition-all cursor-pointer border ${
                    isActive
                      ? "bg-[var(--brand-green)] text-white border-[var(--brand-green)] shadow-md scale-105"
                      : "bg-white text-slate-700 hover:text-slate-900 border-slate-200/90 hover:border-[var(--brand-green)]/30 hover:bg-slate-50"
                  }`}
                >
                  <IconComp
                    className={`w-4 h-4 ${isActive ? "text-[var(--brand-gold)]" : "text-slate-500"}`}
                    aria-hidden="true"
                  />
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="bg-white rounded-3xl p-6 sm:p-8 md:p-10 border border-slate-200/90 shadow-xl relative overflow-hidden">
                <div className="absolute top-0 right-0 w-80 h-80 bg-[var(--brand-green)]/5 rounded-full blur-3xl pointer-events-none" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
                  ...
                  <div className="lg:col-span-7 text-right space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <span className="text-xs font-black font-cairo text-[var(--brand-gold-dark)] dark:text-amber-300 bg-amber-100/80 dark:bg-amber-950/60 px-3 py-1 rounded-md">
                    ...
                    <div className="pt-2 flex flex-wrap gap-4 text-xs font-bold font-cairo text-slate-700">
                      ...
                      <div className="flex items-center gap-1.5 bg-slate-50 px-3.5 py-2 rounded-xl border border-slate-200">
                        ...
                        <span>
                          {activeSector.impactMetrics.completedProjects +
                            activeSector.impactMetrics.activeProjects}{" "}
                          مشروعاً كلياً
                        </span>
                      </div>
                      <div className="flex items-center gap-1.5 bg-slate-50 px-3.5 py-2 rounded-xl border border-slate-200">
                      ...
                      <div className="bg-gradient-to-br from-slate-950 to-slate-900 rounded-2xl p-5 sm:p-6 text-white relative overflow-hidden border border-emerald-500/30 shadow-lg">
                        ...
                        <div className="relative z-10 space-y-3">
                          <div className="flex items-center justify-between">
                            <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-[var(--brand-gold)]/20 text-[#E6C875] text-xs font-bold font-cairo border border-[var(--brand-gold)]/30">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h4 className="text-lg sm:text-xl font-extrabold text-slate-900 font-cairo flex items-center gap-2">
                    <BarChart3 className="w-5 h-5 text-[var(--brand-green)]" aria-hidden="true" />
                  ...
                  <button
                    ...
                    className="text-xs sm:text-sm font-bold font-cairo text-[var(--brand-green)] hover:underline flex items-center gap-1 cursor-pointer"
                  >
                    ...
                    >
                      <div className="space-y-3">
                        <div className="relative h-44 rounded-xl overflow-hidden">
                          ...
                          />
                          <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-md px-3 py-1 rounded-lg text-xs font-bold text-[var(--brand-green)] font-cairo shadow-sm">
                            {project.status}
                          </div>
                      ...
                      <div className="mt-5 pt-4 border-t border-slate-100 space-y-3">
                        ...
                        <div>
                          <div className="flex items-center justify-between text-xs font-bold font-cairo mb-1.5">
                            ...
                            <span className="text-[var(--brand-green)] font-mono">
                        ...
                        <div className="flex items-center justify-between text-xs font-cairo pt-1">
                          <div className="flex items-center gap-1 text-slate-700 font-bold">
                            <Users
                              className="w-3.5 h-3.5 text-[var(--brand-green)]"
                              aria-hidden="true"
                            />
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-[var(--brand-green)] hover:bg-[var(--brand-green)] text-white font-bold text-xs transition-colors cursor-pointer"
                          >
