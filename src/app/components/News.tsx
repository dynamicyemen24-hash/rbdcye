...
const INSPIRATIONAL_CONTENT = [
  ...
  },
  {
    ...
    excerpt:
      "لسنا حملة تقدم المساعدات فقط. نحن بنّاؤون — نبني قدرات، نبني وعي، نبني ثقة. كل طفل نعلمه يصبح معلماً. كل أسرة ندعمها تصبح سندًا لجيرانها. هذا هو التأثير الذي لا يتوقف.",
    category: "تنمية",
    icon: "🌟",
    impact: "تأثير مستدام",
  },
        ...
        >
          ...
          <p className="text-[var(--muted-foreground)] max-w-2xl mx-auto">
            {showInspirational
              ...
              : "تابعوا آخر المستجدات والإنجازات والفعاليات التي تقوم بها حملة رحماء بينهم"}
          </p>
