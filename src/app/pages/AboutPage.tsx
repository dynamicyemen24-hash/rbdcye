...
export default function AboutPage() {
  useSEO({
    ...
    description:
      "حملة رحماء بينهم الخيرية؛ تضامن إنساني وتنموي متكامل منذ 2014م. نعرفكم على هويتنا ورؤيتنا ورسالتنا وقيمنا، ونستعرض أهدافنا وفئاتنا المستهدفة وشركاء النجاح.",
  ...
  const aboutText =
    'حملة "رحماء بينهم" الخيرية؛ حملة دعوية، إنسانية، وتنموية انطلقت عام 2014م استجابةً للأزمة اليمنية ومعاناة المواطن الإنسانية. ومنذ انطلاقها، تسعى الحملة – بدعم أهل الخير – إلى صون حياة الإنسان وإغاثته عبر برامج علمية وإغاثية متنوعة، مستهدفةً المحافظات والمناطق اليمنية الأشد تضرراً ومأساة، انطلقاً من واجبها الشرعي والإنساني.';
