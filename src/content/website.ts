...
export const SEED_SUCCESS_STORIES = [
  {
    ...
    excerpt: 'تقرير يتناول نتائج البرامج التعليمية التي نفذتها المؤسسة في اثنتي عشرة قريةً بالمناطق النائية، شملت خمسمائة طالب وطالبة.',
    quote: 'أظهرت النتائج تحسناً بنسبة ثلاثة وسبعين بالمائة في معدلات القراءة والكتابة بين المستفيدين.',
  ...
  },
  {
    ...
    excerpt: 'ملخص سنوي لجميع المشاريع المنفذة يشمل قطاعات الإغاثة والتعليم والتنمية المجتمعية والمياه والبرامج الدعوية.',
    quote: 'وصل إجمالي الاستثمارات إلى ثلاثمائة وخمسين ألف ريال يمني مستفيدةً منها أكثر من اثني عشر ألفاً وثمنين ألف مستفيد.',
  ...
  },
  {
    ...
    excerpt: 'دراسة معمقة حول فعالية محطات تنقية المياه العاملة بالطاقة الشمسية في عشر قرى بمحافظة مأرب.',
...
export const NEWS_CATEGORIES = [
  ...
  { id: '4', name: 'شراكات', slug: 'partnerships', color: 'var(--chart-3)', bg: 'var(--brand-gold-pale)' },
  { id: '5', name: 'تدريب', slug: 'training', color: 'var(--brand-gold)', bg: 'var(--brand-gold-pale)' },
