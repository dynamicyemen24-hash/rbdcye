...
const defaultSEO = {
  ...
  description: 'منظمة إنسانية تنموية مستقلة مرخصة برقم ٤٨٢ - نعمل على تحقيق التنمية المستدامة ومساعدة المجتمعات المحتاجة في اليمن',
...
export function SEO({
  ...
  }, [fullTitle, metaDescription, metaImage, metaUrl, type, metaKeywords, canonical, structuredData]);
