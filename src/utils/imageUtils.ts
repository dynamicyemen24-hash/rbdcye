...
export const getPlaceholderImage = (
  ...
  const color = category && CATEGORY_COLORS[category] ? CATEGORY_COLORS[category] : "10B981";
...
export const getRandomImage = (category?: string): string => {
  ...
  if (category) {
    const categoryImages: Record<string, string[]> = {
      تعليم: ["/images/defaults/sector-education.svg", "/images/defaults/story-quran.svg"],
      إغاثة: ["/images/defaults/sector-relief.svg", "/images/defaults/project-water.svg"],
      تنمية: [
        "/images/defaults/sector-empowerment.svg",
        "/images/defaults/project-development.svg",
      ],
      تمكين: ["/images/defaults/sector-empowerment.svg", "/images/defaults/story-woman.svg"],
      زراعة: ["/images/defaults/sector-agriculture.svg"],
      رعاية: ["/images/defaults/story-default.svg", "/images/defaults/story-woman.svg"],
