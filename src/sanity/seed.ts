...
async function seed() {
  ...
  try {
    ...
    const project1 = await client.create({
      ...
      description:
        "توزيع كسوة شتوية على الأسر المتضررة من البرد في المناطق المرتفعة في عدة محافظات يمنية.",
      category: "إغاثة",
      status: "active",
      progress: 72,
      budget: 350000,
      ...
      content: [
        {
          ...
          children: [
            {
              _type: "span",
              text: "في إطار جهودها المتواصلة لدعم التعليم في اليمن، أطلقت مؤسسة رحماء بينهم مشروعها السنوي للتعليم المستدام لعام ١٤٤٦هـ.",
            },
          ],
        },
        {
          ...
          children: [
            {
              _type: "span",
              text: "يستهدف المشروع أكثر من ٥٠٠ طالب وطالبة في المناطق النائية، ويشمل توفير المستلزمات المدرسية وحوافز للطلاب والمعلمين.",
            },
          ],
        },
      ],
      ...
      content: [
        {
          ...
          children: [
            {
              _type: "span",
              text: "ضمن حملة الإغاثة الطارئة، وزعت مؤسسة رحماء بينهم ٢٠٠٠ سلة غذائية على الأسر المتضررة في محافظة حجة.",
            },
          ],
        },
      ],
      ...
      content: [
        {
          ...
          children: [
            {
              _type: "span",
              text: "اختتمت مؤسسة رحماء بينهم برنامج التدريب المهني للشباب الذي استمر لمدة ٣ أشهر.",
            },
          ],
        },
      ],
    ...
    const story1 = await client.create({
      ...
      quote:
        "لم أكن أتخيل أنني سأصبح سيدة أعمال تدعم أسرتي وثماني أسر أخرى. مؤسسة رحماء بينهم غيرت حياتي بالكامل.",
      content: [
        {
          _type: "block",
          style: "normal",
          children: [
            {
              _type: "span",
              text: "بدأت فاطمة رحلتها مع المؤسسة بعد أن فقدت زوجها في الحرب. بفضل برنامج تمكين المرأة، تمكنت من إنشاء مشروع خياطة صغير أصبح الآن يدعم ٩ أسر.",
            },
          ],
        },
      ],
    ...
    const story2 = await client.create({
      ...
      quote:
        "كنت على وشك فقدان الأمل، لكن المساعدة التي تلقيتها من المؤسسة أعادت لي ولأسرتي الحياة.",
      content: [
        {
          _type: "block",
          style: "normal",
          children: [
            {
              _type: "span",
              text: "بعد أن دمرت الحرب منزله، تلقى أحمد وأسرته دعماً شاملاً من المؤسسة شمل المأوى والغذاء والرعاية الصحية.",
            },
          ],
        },
      ],
    ...
    const partners = [
      {
        name: "الهيئة الخيرية للإغاثة",
        type: "منظمة غير حكومية",
        status: "active",
        description: "شريك استراتيجي في البرامج الإغاثية",
      },
      {
        name: "وزارة الشؤون الاجتماعية",
        type: "حكومي",
        status: "active",
        description: "الجهة الرسمية المشرفة على العمل الإنساني",
      },
      {
        name: "بنك التضامن الإسلامي",
        type: "خاص",
        status: "active",
        description: "شريك مالي رئيسي",
      },
      {
        name: "مؤسسة العون للتنمية",
        type: "منظمة غير حكومية",
        status: "active",
        description: "شريك في برامج التنمية المستدامة",
      },
      {
        name: "شركة الاتصالات اليمنية",
        type: "خاص",
        status: "active",
        description: "شريك تقني وداعم للحملات",
      },
    ];
    ...
    const faqs = [
      {
        ...
        answer:
          "يمكنك التبرع عبر موقعنا الإلكتروني من خلال قسم التبرع السريع، أو عبر التحويل البنكي، أو من خلال زيارة مقر المؤسسة.",
        category: "donations",
        order: 1,
      },
      {
        question: "هل تبرعاتي تصل إلى المستحقين؟",
        answer:
          "نعم، تصل تبرعاتكم إلى المستحقين عبر فرقنا الميدانية المنتشرة في جميع المحافظات، مع تقارير دورية توضح أثر التبرع.",
        category: "donations",
        order: 2,
      },
      {
        ...
        answer:
          "يمكنك التسجيل في قسم التطوع عبر موقعنا، وسيتواصل معك فريق التطوع لتحديد المجال المناسب لمهاراتك.",
        category: "volunteering",
        order: 3,
      },
      {
        question: "ما هي مجالات عمل المؤسسة؟",
        answer:
          "تعمل المؤسسة في مجالات الإغاثة الطارئة، التعليم، التنمية المستدامة، التدريب المهني، وتمكين المرأة.",
        category: "general",
        order: 4,
      },
      {
        question: "هل يمكنني تخصيص تبرعي لمشروع معين؟",
        answer: "نعم، يمكنك اختيار المشروع الذي ترغب في دعمه من قائمة المشاريع المتاحة على موقعنا.",
        category: "donations",
        order: 5,
      },
      {
        question: "كيف يمكنني التواصل مع المؤسسة؟",
        answer:
          "يمكنك التواصل عبر البريد الإلكتروني info@rbdcye.org أو عبر الهاتف +967 1 234 567 أو عبر واتساب.",
        category: "general",
        order: 6,
      },
    ];
    ...
    const testimonials = [
      {
        name: "أم محمد",
        role: "مستفيدة من برنامج الإغاثة",
        quote: "جزى الله القائمين على هذه المؤسسة كل خير، لقد كانوا سنداً لنا في أصعب الظروف.",
        rating: 5,
        status: "published",
      },
      {
        name: "سامي عبدالله",
        role: "متطوع",
        quote: "التطوع مع رحماء بينهم تجربة رائعة، أشعر أنني أساهم في تغيير حقيقي.",
        rating: 5,
        status: "published",
      },
      {
        name: "خالد حسن",
        role: "مستفيد من برنامج التدريب",
        quote: "بفضل التدريب المهني الذي حصلت عليه، تمكنت من فتح مشروعي الخاص.",
        rating: 4,
        status: "published",
      },
    ];
